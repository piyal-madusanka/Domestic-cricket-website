...
<div class="modal fade" id="interviewpostupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       ...
       <input type="file" name="image" id="image" /> 
          ...
          <textarea  type="text" name="post" class="form-control" placeholder="Enter Description" ></textarea>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="interviewpostuploadbtn" id="postuploadbtn" value="postuploadbtn" >Save changes</button>
      </div>
      </form>
	...
	<div class="card shadow-mb-4">
		<div class="card-header py-3 ">
			<h6 class="m-0 front-weight-bolt text-primary">Top Interview Postupload section
				<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#interviewpostupload">
  Add post
</button>
			</h6>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $row['link']; ?>  </td>
                ...
                <td>
            <form action="interviewpostedit.php" method="POST">
          ...
          <form action="code.php" method="POST">
           ...
           <button type="submit" name="interviewpost_deletbtn" class="btn btn-danger">DELETE</button> 
           </form>
