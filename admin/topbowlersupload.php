...
<div class="modal fade" id="momentpostupload" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">upload Top bowlers post</h5>
      ...
      <div class="modal-body">
       ...
       <input type="file" name="image" id="image" /> 
          ...
          <textarea cols="10" type="text" name="post" class="form-control" placeholder="Enter Description"></textarea>
          ...
          <input type="text" name="totalscore" class="form-control" placeholder="Enter Total score" >
            ...
            <div class="form-group">
          <label>Higher wicket per inning</label>
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="topbowlerspostuploadbtn" id="postuploadbtn" value="postuploadbtn" >Save changes</button>
      </div>
      </form>
	...
	<div class="card shadow-mb-4">
		<div class="card-header py-3 ">
			<h6 class="m-0 front-weight-bolt text-primary">top bowlers Post upload section
  ...
  <thead>
    <tr>
      ...
      <th scope="col">Higher wicket per inning</th>
