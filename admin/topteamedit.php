...
<div class="container-fluid">
    ...
    {
      $id =$_POST['edit_id'];
      $query="SELECT * FROM teampost WHERE id='$id'";
    ...
    <form action="code.php" method="POST" enctype="multipart/form-data">
    	<input type="hidden" name="edit_id" value="<?php echo $row['id']  ?>">
         ...
         <a href="topteampostupload.php" class="btn btn-danger">Cancel</a>   
         <button class="btn btn-primary" type="submit" name="teampostupdatebtn" >Update</button> 
         </form>
      	<?php
