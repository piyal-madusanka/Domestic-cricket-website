  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-primary" name="teampostuploadbtn" id="postuploadbtn" value="postuploadbtn" >Save changes</button>
      </div>
      </form>
	...
	<div class="card shadow-mb-4">
		<div class="card-header py-3 ">
			<h6 class="m-0 front-weight-bolt text-primary">Top Team Postupload section
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo  '<img src="data:image/jpeg;base64,'.base64_encode($row['image']).'" height="100" width="100"/>';     ?>  </td>
                ...
                <td>
            <form action="topteamedit.php" method="POST">
          ...
          <form action="code.php" method="POST">
           ...
           <button type="submit" name="teampost_deletbtn" class="btn btn-danger">DELETE</button> 
           </form>
