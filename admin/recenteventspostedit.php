...
<div class="container-fluid">
    ...
    {
      $id =$_POST['edit_id'];
      $query="SELECT * FROM recenteventspost WHERE id='$id'";
    ...
    <form action="code.php" method="POST" enctype="multipart/form-data">
    	<input type="hidden" name="edit_id" value="<?php echo $row['id']  ?>">
         ...
         <button class="btn btn-primary" type="submit" name="recenteventspostupdatebtn" onclick="checkDetails()">Update</button> 
         </form>
      	<?php
