  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">upload Top allrounders post</h5>
      ...
      <div class="modal-body">
       ...
       <input type="file" name="image" id="image" /> 
          ...
          <input type="text" name="totalwicket" class="form-control" placeholder="Enter Total score" >
        </div>
            <div class="form-group">
        ...
        <div class="form-group">
          <label>Highest Wicket for inning</label>
          <input type="text" name="wicket" class="form-control" placeholder="Enter highscore" >
        </div>
            <div class="form-group">
          <label>Average</label>
	...
	<div class="card shadow-mb-4">
		<div class="card-header py-3 ">
			<h6 class="m-0 front-weight-bolt text-primary">top allrounder Post upload section
